...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="relative h-[600px] w-[730px] bg-transparent rounded shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] flex flex-row ">
        <div
        ...
        <div className="bg-gray-100 h-full w-[300px]">
        ...
        <div className=" h-full w-[430px]">
          {page === 1 && (
            <>
              ...
              >
                <h1 className="mb-[3rem] text-4xl font-medium">
                  Account Details
                </h1>
