...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="container h-[400px] w-[500px] rounded overflow-hidden shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px]">
        <label>
          <h1 className="text-2xl text-center  m-3 pt-4 font-medium">
            WELCOME BACK
          </h1>
        </label>
        <form
        ...
        >
          ...
          <div className="flex justify-between">
            <label>Don have an account?</label>{" "}
            <Link
              to={"/register"}
